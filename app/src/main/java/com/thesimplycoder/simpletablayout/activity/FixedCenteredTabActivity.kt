...
import kotlinx.android.synthetic.main.activity_fixed_centered_tab.*

class FixedCenteredTabActivity : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_fixed_centered_tab)

        setTitle("Fixed-Centered Tab")
